...
import SuggestBenefitModal from "./SuggestBenefitModal";
    ...
    <div className="space-y-12">
        ...
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="bg-gray-900 text-white px-4 py-1.5 rounded-lg text-sm font-semibold hover:bg-gray-800 transition-colors shadow-sm"
            >
              + Sugerir Benefício
            </button>
            <span className="bg-amber-400 text-amber-900 px-4 py-1.5 rounded-full text-sm font-bold shadow-sm flex items-center">
              4 ofertas
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white border border-amber-400 rounded-2xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-5 flex-1 flex flex-col">
              <span className="bg-amber-100 text-amber-800 text-[10px] font-bold px-2 py-1 rounded w-fit mb-2 uppercase tracking-wide">
                Saúde & Bem-estar
              </span>
              ...
              <p className="text-sm text-gray-500 mt-1 mb-4">
                Desconto em qualquer plano anual
              </p>
          ...
          <div className="bg-white border border-amber-400 rounded-2xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow">
            <div className="relative h-40 bg-gray-800">
              <img
                src="https://images.unsplash.com/photo-1585435557343-3b092031a831?q=80&w=400&auto=format&fit=crop"
                alt="Farmácia"
                className="w-full h-full object-cover opacity-60"
              />
              <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="bg-white border border-amber-400 rounded-2xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow">
            <div className="relative h-40 bg-gray-800">
              <img
                src="https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=400&auto=format&fit=crop"
                alt="Cinema"
                className="w-full h-full object-cover opacity-60"
              />
              <div className="absolute inset-0 flex items-center justify-center">
      ...
      <section>
        <div className="mb-6">
          ...
          <p className="text-gray-500 mt-1">
            Explore outras vantagens disponíveis
          </p>
        </div>
