...
export function EmployeePage() {
  ...
  const progressToNextLevel = (employee.points / employee.nextLevelPoints) * 100;
          ...
          <div className="flex items-start justify-between">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-lg">{employee.points} pontos</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 min-w-[300px]">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm font-bold">{pointsToNextLevel} pontos faltam</span>
              </div>
              ...
              <p className="text-xs text-gray-400">Meta: {employee.nextLevelPoints} pontos</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
              ...
              <p className="text-3xl font-bold">{employee.tasksCompleted}/{employee.totalTasks}</p>
            </div>
                  ...
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex-1">
                      <div className="flex items-start gap-3 mb-3">
                        <div className={`w-10 h-10 ${statusStyles.bg} rounded-lg flex items-center justify-center flex-shrink-0`}>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600">
                            ...
                            <span>•</span>
                            <span className="text-[#FFD700] font-semibold">Prêmio: {task.prize}</span>
                          </div>
                        </div>
                        <div className={`px-3 py-1 ${statusStyles.bg} ${statusStyles.text} rounded-full text-sm font-semibold`}>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm text-gray-600">Progresso: {task.current}/{task.goal}</span>
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                          ...
                          <Icon className={`w-6 h-6 ${reward.canRedeem ? 'text-black' : 'text-gray-400'}`} />
                        </div>
                      </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="bg-[#FFD700] bg-opacity-20 rounded-lg p-4 text-center">
                    ...
                    <p className="font-bold text-lg mb-1">{employee.rewards} prêmios</p>
                    <p className="text-sm text-gray-600">conquistados no total</p>
                  </div>
                </div>
              </div>
            </div>
